...
// const startfn = (scene, gameData) => {
        //   console.log("logic recall", scene, gameData);
...
//     if (this.gameLogic.quitButton) this.gameLogic.quitButton.destroy();
//     if (this.gameLogic.replayButton) this.gameLogic.replayButton.destroy();
...
//         const gameLogic.scoreText = this.scene.add.text(textwidth, y, '' + total, { ...basestyle, }).setOrigin(1, 0);
//         objs.push(nametext);
//         objs.push(gameLogic.scoreText);
//       });
...
//     this.gameLogic.replayButton = this.makeReplayButton();
